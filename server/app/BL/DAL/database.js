...
exports.getProductsPagingByCategory = function (category, page, limit, callback) {
    var perPage = limit;
    db.product
        .find({
            "category": category
...
exports.updateProduct = function (idProduct, productToUpdate, callback) {
    ...
    var updateQuery = {
        ...
        "UnitQty": productToUpdate.UnitQty,
        "ManufacturerItemDescription": productToUpdate.ManufacturerItemDescription,
        "UnitOfMeasurePrice": productToUpdate.UnitOfMeasurePrice
    };
    var options = {
        upsert: true
    };
